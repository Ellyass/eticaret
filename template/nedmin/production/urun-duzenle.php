        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Ürün Keywords <span class="required">*</span>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="first-name" name="urun_keywords" value="<?php echo $uruncek['urun_keywords'] ?>"  class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
               <select id="heard" class="form-control" name="urun_onecıkar" required>


          <option value="1" <?php echo $uruncek['urun_onecıkar'] == '1' ? 'selected=""' : ''; ?>>Evet</option>

          <option value="0" <?php if ($uruncek['urun_onecıkar']==0) { echo 'selected=""'; } ?>>Hayır</option>
