...
if (isset($_POST['logoduzenle'])) {
    ...
    $refimgyol = substr($uploads_dir, 6) . "/" . $benzersizsay4 . $name;

    @move_uploaded_file($tmp_name, "$uploads_dir/$benzersizsay4$name");
...
if (isset($_POST['urunekle'])) {
    ...
    $insert = $ayarekle->execute(array(
        ...
        'urun_onecıkar' => $_POST['urun_onecıkar']
    ));
